@extends('dashboard.layouts.simple.master')
        ...
        <div class="row widget-grid">
            <div class="col-xxl-4 col-sm-6 box-col-6">
                <div class="card profile-box">
                    <div class="card-body">
                        ...
                        <div class="cartoon"><img class="img-fluid" src="{{ asset('dashboard/assets/images/dashboard/cartoon.svg') }}"
                            ...
                            <div class="card-body">
                                <div class="widget-content">
                                    <div class="widget-round secondary">
                                        <div class="bg-round">
                                            <svg class="svg-fill">
                                                <use href="{{ asset('dashboard/assets/svg/icon-sprite.svg#cart') }}"> </use>
                                            </svg>
                                ...
                                <div class="card-body">
                                    <div class="widget-content">
                                        <div class="widget-round primary">
                                            <div class="bg-round">
                                                <svg class="svg-fill">
                                                    <use href="{{ asset('dashboard/assets/svg/icon-sprite.svg#tag') }}"> </use>
                                                </svg>
                                                <svg class="half-circle svg-fill">
                                                    <use href="{{ asset('dashboard/assets/svg/icon-sprite.svg#halfcircle') }}"></use>
                                                </svg>
                            ...
                            <div class="card-body">
                                <div class="widget-content">
                                    <div class="widget-round warning">
                                        <div class="bg-round">
                                            <svg class="svg-fill">
                                                <use href="{{ asset('dashboard/assets/svg/icon-sprite.svg#return-box') }}"> </use>
                                            </svg>
                                            <svg class="half-circle svg-fill">
                                                <use href="{{ asset('dashboard/assets/svg/icon-sprite.svg#halfcircle') }}"></use>
                                            </svg>
                                ...
                                <div class="card-body">
                                    <div class="widget-content">
                                        <div class="widget-round success">
                                            <div class="bg-round">
                                                <svg class="svg-fill">
                                                    <use href="{{ asset('dashboard/assets/svg/icon-sprite.svg#rate') }}"> </use>
                                                </svg>
                                                <svg class="half-circle svg-fill">
                                                    <use href="{{ asset('dashboard/assets/svg/icon-sprite.svg#halfcircle') }}"></use>
                                                </svg>
                                ...
                                <div class="row g-sm-4 g-2">
                                    <div class="col-xl-12 col-md-4">
                                        <div class="light-card balance-card widget-hover">
                                            <div class="svg-box">
                                                <svg class="svg-fill">
                                                    <use href="{{ asset('dashboard/assets/svg/icon-sprite.svg#income') }}"></use>
                                                </svg>
                                            </div>
                                    ...
                                    <div class="col-xl-12 col-md-4">
                                        <div class="light-card balance-card widget-hover">
                                            <div class="svg-box">
                                                <svg class="svg-fill">
                                                    <use href="{{ asset('dashboard/assets/svg/icon-sprite.svg#expense') }}"></use>
                                                </svg>
                                            </div>
                                    ...
                                    <div class="col-xl-12 col-md-4">
                                        <div class="light-card balance-card widget-hover">
                                            <div class="svg-box">
                                                <svg class="svg-fill">
                                                    <use href="{{ asset('dashboard/assets/svg/icon-sprite.svg#doller-return') }}">
                                                    </use>
                                                </svg>
                                            </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle"
                                                    src="{{ asset('dashboard/assets/images/dashboard/user/1.jpg') }}"
                                                    alt="user"></td>
                                            <td class="img-content-box"><a class="d-block f-w-500"
                                                    href="#">Jane Cooper</a><span
                                        ...
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle"
                                                    src="{{ asset('dashboard/assets/images/dashboard/user/2.jpg') }}"
                                                    alt="user"></td>
                                            <td class="img-content-box"><a class="d-block f-w-500"
                                                    href="#">Brooklyn Simmons</a><span
                                        ...
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle"
                                                    src="{{ asset('dashboard/assets/images/dashboard/user/3.jpg') }}"
                                                    alt="user"></td>
                                            <td class="img-content-box"><a class="d-block f-w-500"
                                                    href="#">Leslie Alexander</a><span
                                        ...
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle"
                                                    src="{{ asset('dashboard/assets/images/dashboard/user/4.jpg') }}"
                                                    alt="user"></td>
                                            <td class="img-content-box"><a class="d-block f-w-500"
                                                    href="#">Travis Wright</a><span
                                        ...
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle"
                                                    src="{{ asset('dashboard/assets/images/dashboard/user/5.jpg') }}"
                                                    alt="user"></td>
                                            <td class="img-content-box"><a class="d-block f-w-500"
                                                    href="#">Mark Green</a><span
            ...
            <div class="col-xxl-3 col-md-6 box-col-6 col-ed-none wow zoomIn">
                <div class="card purchase-card"><img class="img-fluid"
                        src="{{ asset('dashboard/assets/images/dashboard/purchase.png') }}" alt="vector mens with leptop">
            ...
            <div class="col-xxl-5 col-lg-8 col-md-11 box-col-8 col-ed-6">
                <div class="card papernote-wrap">
                    ...
                    <div class="card-body pt-0"> <img class="banner-img img-fluid"
                            src="{{ asset('dashboard/assets/images/dashboard/papernote.jpg') }}" alt="multicolor background">
                                ...
                                <div class="customers">
                                    <ul>
                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                src="{{ asset('dashboard/assets/images/dashboard/user/1.jpg') }}" alt="user">
                                        </li>
                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                src="{{ asset('dashboard/assets/images/dashboard/user/6.jpg') }}" alt="user">
                                        </li>
                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                src="{{ asset('dashboard/assets/images/dashboard/user/7.jpg') }}" alt="user">
                                        </li>
                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                src="{{ asset('dashboard/assets/images/dashboard/user/3.jpg') }}" alt="user">
                                        </li>
                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                src="{{ asset('dashboard/assets/images/dashboard/user/8.jpg') }}" alt="user">
                                        </li>
...
@section('script')
    ...
    <script src="{{ asset('dashboard/assets/js/chart/apex-chart/moment.min.js') }}"></script>
